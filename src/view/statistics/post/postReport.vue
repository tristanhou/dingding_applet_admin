        ...
        <Card style="height:84vh; overflow-y:auto">
          ...
          <Row class="table-top" style="marginBottom: 11px;">
            <div style="float: left;">
              ...
              <Select v-model="queryParams.projectId" style="width:160px; marginRight:5px" :filterable="true" placeholder="项目名称">
              ...
              <Input v-model="queryParams.dingTalkUserName"  style="width:160px; marginRight:5px"  placeholder="填写人名称" />
              <!-- <Input v-model="queryParams.position"  style="width:160px; marginRight:5px"  placeholder="岗位名称" /> -->
              <Date-picker type="year" :value="year" placeholder="选择日期" style="width: 160px" @on-change="onDateChange"></Date-picker>
              <Button style="marginRight:5px; marginLeft:5px" type="primary" @click="searchPost">查询</Button>
...
export default {
    ...
    // pdt 列表 change 事件
        ...
        initTableData(val) {
            ...
            getTableData ('/proxy/attendance/report/selReportByPosition', params)
                .then (res => {
                    if (res.data) {
                        debugger;
       ...
       */
            ...
            if (this.postData.length === 0) {
                ...
                getExportData('/proxy/attendance/report/selReportByPositionExport', params)
                    .then(res => {
                        /**
           * 方法二：通过返回 Blob 文件
           */
                        ...
                        link.href = url;
                        link.setAttribute('download', '岗位统计表.xlsx');
                        link.click();
                        link.remove();
                    })
                    .catch(err => {
