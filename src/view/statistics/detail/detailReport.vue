    ...
    <Row :gutter="16">
      <Col span="24">
        <Card style="height:80vh; overflow-y:auto">
          ...
          <Tables :columns="detailColumns" :totalPage="totalRecord" :show-total="false" @on-page-change="pageChange" :currentPage="currentPage" :data="detailData" v-model="detailData" ref="table" :height="500" @on-page-size-change="pageSizeChange">
          </Tables>
        </Card>
      </Col>
    </Row>
...
export default {
    ...
    methods: {
        ...
        getQueryParams() {
            ...
            Array.isArray(queryParams.dailyDate) && delete obj.dailyDate
            return obj;
        },
        // 根据查询条件搜索明细表
        searchDetail() {
