    ...
    <Row :gutter="16">
      <Col span="24">
        <Card style="height:80vh; overflow-y:auto">
          ...
          <Tables :columns="columns1" :data="data1" v-model="data1" :height="500" @on-page-change="pageChange" @on-page-size-change="pageSizeChange" :totalPage="total" :currentPage="currentPage" style="overflow-y:auto">
          </Tables>
        </Card>
      </Col>
    </Row>
...
export default {
    ...
    // 启用或停用
        ...
        initTableData (param) {
			...
			if (param) {
				(param.pdtId != undefined && param.pdtId != '') && (params['pdtId'] = param.pdtId);
				(param.projectName != undefined && param.projectName != '')&& (params['projectName'] = param.projectName);
			}
